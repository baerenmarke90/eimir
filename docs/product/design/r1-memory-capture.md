...
| Loading / pending | Existing F2 pending lock (fieldset disabled, submit button freezes to `Wird gespeichert …`, synchronous duplicate-submit guard) is retained unchanged. |
