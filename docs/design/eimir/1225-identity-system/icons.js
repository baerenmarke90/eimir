...
const ICON_PATHS = {
  wir: '<circle cx="9" cy="12" r="6.5"/><circle class="accent" cx="15" cy="12" r="6.5"/>',
  ...
  denken: '<path d="M11.7 19.5S3 15 3 9.6a4 4 0 0 1 7.4-2.1 4 4 0 0 1 7.4 2.1c0 1.3-.5 2.5-1.3 3.6"/><path class="accent" d="m15.5 15.3 1.3-2.4 1.3 2.4 2.4 1.3-2.4 1.3-1.3 2.4-1.3-2.4-2.4-1.3 2.4-1.3Z"/>',
  ...
  pro: '<path d="M3 17 5 6l5 4 2-7 2 7 5-4 2 11H3Zm1 3h16"/><path class="accent" d="M12 3v7"/>',
...
function icon(name, variant = 'outline', size = 24) {
  const source = variant === 'filled' ? (FILLED[name] || ICON_PATHS[name]) : variant === 'duotone' && FILLED[name] ? FILLED[name] + ICON_PATHS[name] : ICON_PATHS[name];
