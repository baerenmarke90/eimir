...
Generated by `web/e2e/tests/today-pro-insights.spec.ts` (mocked API, axe and horizontal-overflow checks included) and stored in [`evidence/1151/`](evidence/1151/): Compact 390 px Light (Today entry, week, patterns, recap, gated Free state), 320 px Dark with 200 % text and Reduced Motion (week, patterns, recap) and Expanded 1280 px Light (week, patterns, recap).
