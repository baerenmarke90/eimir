...
class ErrorCode:
    ...
    NOTIFICATION_PUSH_NOT_ALLOWED = "NOTIFICATION_PUSH_NOT_ALLOWED"
    NOTIFICATION_EMAIL_NOT_ALLOWED = "NOTIFICATION_EMAIL_NOT_ALLOWED"
    NOTIFICATION_EMAIL_TRANSPORT_UNAVAILABLE = "NOTIFICATION_EMAIL_TRANSPORT_UNAVAILABLE"
    NOTIFICATION_EMAIL_VERIFIED_PRIMARY_MISSING = "NOTIFICATION_EMAIL_VERIFIED_PRIMARY_MISSING"
    NOTIFICATION_PREFERENCE_ACCOUNT_UNAVAILABLE = "NOTIFICATION_PREFERENCE_ACCOUNT_UNAVAILABLE"
    PUSH_ENDPOINT_ACCOUNT_UNAVAILABLE = "PUSH_ENDPOINT_ACCOUNT_UNAVAILABLE"
    PUSH_ENDPOINT_INVALID = "PUSH_ENDPOINT_INVALID"
    PUSH_ENDPOINT_LIMIT_REACHED = "PUSH_ENDPOINT_LIMIT_REACHED"
    PUSH_ENDPOINT_NOT_FOUND = "PUSH_ENDPOINT_NOT_FOUND"
    PUSH_TRANSPORT_UNAVAILABLE = "PUSH_TRANSPORT_UNAVAILABLE"
