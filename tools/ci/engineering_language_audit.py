...
EXCLUDED_PLATFORM_PATHS = {
    ...
    # Generated by `cap sync` from the Web build and capacitor.config.ts; the
    # wrapper's handwritten sources stay inside the audit boundary.
...
EXCLUDED_PLATFORM_PREFIXES = (
    ...
    Path("android/build"),
    Path("android/capacitor-cordova-android-plugins"),
