...
| How is the finished Memory capture composed? | [R1 Neuer Moment](r1-memory-capture.md): content-first hierarchy, reuse decisions and exact-build production evidence; retired Compose evidence remains historical. |
...
| --- | --- | --- |
| [Product Reference v1](product-reference-v1.md), [reference screens](reference-screens.md), [system direction](design-system-direction.md), [Web Motion Guideline](motion-guideline.md) | STILL_NORMATIVE | Current approved product/design direction. The Motion Guideline is the lower-level Web engineering contract for section 8; it cannot override Product Reference v1. |
...
| [Android navigation ADR 0004](../../decisions/0004-android-uses-bottom-navigation-at-every-size.md) | SUPERSEDED | Described the retired Compose client. Android ships the Web product through Capacitor ([ADR 0011](../../decisions/0011-web-first-pwa-capacitor-mobile-delivery.md)); mobile Web navigation is governed by v1. |
| [ADR 0011 Web-first PWA and Capacitor delivery](../../decisions/0011-web-first-pwa-capacitor-mobile-delivery.md) | STILL_NORMATIVE | One product UI (React/Vite) for Web, PWA and Capacitor Android; no independent native product UI or screen-by-screen native parity. |
...
| Closed-slice evidence that names the Android Compose client (F1/F2 proof Activities, R1-R4 "Web/Android evidence", emulator captures, native parity inventories, and the M5 Android delivery plan) | HISTORICAL | The Compose client and its capture tooling were removed in #1009 ([ADR 0011](../../decisions/0011-web-first-pwa-capacitor-mobile-delivery.md)). The records show what was verified on their builds; they do not require, and cannot justify, a native re-implementation. |
...
| [2026-09-22 Web Motion audit](audits/2026-09-22-motion-audit.md) | HISTORICAL | Source-level inventory and root-cause snapshot for #1204. The Motion Guideline and current repository state govern later implementation. |
